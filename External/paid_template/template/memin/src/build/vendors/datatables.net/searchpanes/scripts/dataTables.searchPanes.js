    ...
    var SearchPane = /** @class */ (function () {
        ...
        function SearchPane(paneSettings, opts, idx, layout, panesContainer, panes) {
            ...
            this.dom = {
                ...
                clear: $('<button type="button"><i class="fa fa-times"></i></button>')
                ...
                countButton: $('<button type="button"><i class="fa fa-sort-amount-down"></i></button>')
                    .addClass(this.classes.paneButton)
                ...
                nameButton: $('<button type="button"><i class="fa fa-sort-alpha-up"></button>')
                    .addClass(this.classes.paneButton)
                    .addClass(this.classes.nameButton),
                panesContainer: panesContainer,
                searchBox: $('<input/>').addClass(this.classes.paneInputButton).addClass(this.classes.search),
                searchButton: $('<button type = "button" class="' + this.classes.searchIcon + '"><i class="fa fa-search"></i></button>')
                    .addClass(this.classes.paneButton),
