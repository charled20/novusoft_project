            ...
            <div class="">
                <form action="" method="POST">
                    <div class="mx-auto col-sm-9 d-flex justify-content-around text-center">
                        <button type="button" class="btn btn-light border active col-sm-3 py-2 quot">ITEM</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 quot">PRICE COMPARISON</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 quot">PROJECT SUMMARY</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 quot">ACCOUNTING</button>
                    </div>
                </form>                
            </div>

            <div class="col-sm-12" id="data-table-quot">
                <?php include "sub_pages/pq_tb_1.php";?>
            </div>
        </div>
    ...
    <script>
        $(function() {
            $('.quot').click(function() {
                ...
                if(textval=="ITEM"){
                    $.ajax({
                            ...
                            success: function(data){
                                //console.log(data);
                                $('.quot').removeClass('active');
                                $(this).addClass('active');
                                $("#data-table-quot").empty();
                                $("#data-table-quot").append(data);
                            },
                            error: function(data){
                            alert('Error!');
                            }
                ...
                else if(textval=="PRICE COMPARISON"){
                    $.ajax({
                            type: 'POST',
