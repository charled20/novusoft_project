            ...
            <div class="col-sm-6">
                <div class="col-sm-7">
                    <div class="form-group-sm row">
                            <label class="col col-form-label">Requester</label>
                        <div class="container col-sm-8 row">
                            <input type="text" class="col-sm-6 form-control" id="requester" placeholder="User">
                            <input type="text" class="col-sm-6 form-control" id="requester" placeholder="Manager">
                        </div>
                    </div> 
                    <div class="form-group-sm row">
                            <label class="col col-form-label">Requester Name</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="requster_name" placeholder="EquiParco Construction Company" disabled>
                        </div>
                    </div>     
                    <div class="form-group-sm row">
                    ...
                    <div class="form-group-sm row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="department" placeholder="General">
                        </div>
                    </div>  
                    <div class="form-group-sm row">
            ...
            <div class="">
                <form action="" method="POST">
                    <div class="mx-auto col-sm-9 d-flex justify-content-around text-center">
                        <button type="button" class="btn btn-light border active col-sm-3 py-2 header">ITEM</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 header">BUDGET</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 header">PROJECT SUMMARY</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 header">ACCOUNTING</button>
                    </div>
                </form>                
            </div>

            <div class="col-sm-12" id="data-table">
                <?php include "sub_pages/pr_tb_1.php";?>
            </div>
        </div>
        ...
        <div class="col-sm-12 row d-flex justify-content-between">
            ...
            <div class="col-sm-4">
                <div class="form-group-sm row col">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="tot_before_disc" placeholder="21,900.00" disabled>
                    </div>
                </div> 
                <div class="form-group-sm row col">
                ...
                <div class="form-group-sm row col">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="tot_pymnt_due" placeholder="21,900.00"> 
                    </div>
                </div> 
            </div>
        </div>
        ...
        <div class="col-sm-12 row d-flex justify-content-between">
            ...
            <div class="col-sm-2">
                <div class="form-group-sm row d-flex justify-content-end">
                    ...
                    <div class="col-sm-6">
                        <button type="button" class="btn btn-secondary p-3" disabled>Copy To</button>
                    </div>
                </div> 
            </div>
        </div>
