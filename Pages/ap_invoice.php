...
<body>
            ...
            <div class="col-sm-6">
                <div class="col-sm-7">
                    <div class="form-group-sm row">
                            <label class="col col-form-label">Vendor</label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" id="vendor_code" placeholder="V20005">
                        </div>
                    </div> 
                    <div class="form-group-sm row">
            ...
            <div class="">
                <form action="" method="POST">
                    <div class="mx-auto col-sm-9 d-flex justify-content-around text-center">
                        <button type="button" class="btn btn-light border active col-sm-3 py-2 ap_inv">CONTENTS</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 ap_inv">LOGISTICS</button>
                        <button type="button" class="btn btn-light border col-sm-3 py-2 ap_inv">ACCOUNTING</button>
                    </div>
                </form>                
            </div>

            <div class="col-sm-12" id="data-table-ap_inv">
                <?php include "sub_pages/ap_inv_tb_1.php";?>
            </div>
        </div>
    ...
    <script>
        $(function() {
            $('.ap_inv').click(function() {
                textval = $(this).text();
                //alert(textval);
                if(textval=="CONTENTS"){
                    $.ajax({
                            type: 'POST',
                            url: "Pages/sub_pages/ap_inv_tb_1.php",
                            data: {textval : textval },
                            success: function(data){
                                //console.log(data);
                                $('.ap_inv').removeClass('active');
                                $(this).addClass('active');
                                $("#data-table-ap_inv").empty();
                                $("#data-table-ap_inv").append(data);
                            },
                            error: function(data){
                            alert('Error!');
                            }
                    ...
                    $.ajax({
                            type: 'POST',
                            url: "Pages/sub_pages/ap_inv_tb_2.php",
                            data: {textval : textval },
                            success: function(data){
                                console.log(data);
                                $('.ap_inv').removeClass('active');
                    ...
                    $.ajax({
                            type: 'POST',
                            url: "Pages/sub_pages/ap_inv_tb_3.php",
                            data: {textval : textval },
                            success: function(data){
                                $('.ap_inv').removeClass('active');
                                $(this).addClass('active');
